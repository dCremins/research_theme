...
function setup() {
  ...
  register_nav_menus([
    'header-menu'     => __('Header', 'sage'),
    'header-utility'  => __('Header Utility', 'sage')
  ]);
...
function widgets_init() {
  ...
  register_sidebar([
    'name'          => __('Home Wide', 'sage'),
    'id'            => 'sidebar-home-wide',
    'before_widget' => '<section class="widget %1$s %2$s">',
    'after_widget'  => '</section>',
    'before_title'  => '<h3>',
    'after_title'   => '</h3>'
...
function adminAssets() {
  wp_enqueue_style( 'sage/adminCSS', Assets\asset_path('styles/admin.css'), false, null);
}
...
function assets() {
  ...
  wp_enqueue_script('sage/js', Assets\asset_path('scripts/main.js'), ['jquery'], null, true);
	wp_register_script('menu_toggle', Assets\asset_path('scripts/menu_toggle.js'), '', '', true);
